import{j as o}from"./jsx-runtime-EKYJJIwR.js";import{N as a,u as S,s as n,S as w,L as T}from"./StoryHeader-BFpNeWau.js";import"./index-BCtMShv3.js";import"./index-BqCLlfdy.js";import"./index-D-fs5e6L.js";import"./QueryClientProvider-BryXDp-x.js";const H={title:"GitLog",component:a,parameters:{layout:"fullscreen"},args:{entries:[],showTable:!0,currentBranch:"release",showBranchesTags:!0,showCommitNodeHashes:!1,showCommitNodeTooltips:!1,showHeaders:!0,showGitIndex:!0,enableResize:!1,nodeTheme:"default",nodeSize:20,orientation:"normal",onSelectCommit:e=>{console.info(`Selected commit ${e==null?void 0:e.hash}`)},defaultGraphWidth:200,rowSpacing:0,page:0,pageSize:200},argTypes:{entries:{name:"Git Log Entries",table:{category:"Required Props"}},currentBranch:{name:"Current Branch",table:{category:"Required Props"}},showCommitNodeHashes:{name:"Show Commit Hashes",table:{category:"Visibility"}},showTable:{name:"Show Table",table:{category:"Visibility"}},showBranchesTags:{name:"Show Branches / Tags",table:{category:"Visibility"}},showHeaders:{name:"Show Headers",table:{category:"Visibility"}},showCommitNodeTooltips:{name:"Show Commit Tooltips",table:{category:"Visibility"}},nodeTheme:{name:"Node Style",table:{category:"Visibility"},control:"radio",options:{Default:"default",Plain:"plain"}},showGitIndex:{name:"Show Git Index",table:{category:"Visibility"}},pageSize:{name:"Page Size",table:{category:"Pagination"},control:{type:"range",min:1,max:300}},page:{name:"Page Number",table:{category:"Pagination"},control:{type:"range",min:0,max:50}},enableResize:{name:"Enable Resize",table:{category:"Dimensions"}},rowSpacing:{name:"Row Spacing",table:{category:"Dimensions"},control:{type:"range",min:0,max:50}},defaultGraphWidth:{name:"Graph Width",table:{category:"Dimensions"},control:{type:"range",min:100,max:500}},nodeSize:{name:"Graph Node Size",table:{category:"Dimensions"},control:{type:"range",min:8,max:30,step:2}},orientation:{name:"Graph Orientation",table:{category:"Dimensions"},control:"radio",options:{Normal:"normal",Flipped:"flipped"}},onSelectCommit:{name:"onSelectCommit",table:{category:"Callback Functions"}}}},t={render:e=>{const{theme:s,loading:r,colours:l,entries:i,branch:c,buildUrls:p,repository:u,backgroundColour:m,handleChangeTheme:b,handleChangeColors:y,handleChangeRepository:C}=S();return o.jsxs("div",{style:{background:m},className:n.container,children:[o.jsx(w,{theme:s,colours:l,repository:u,onChangeTheme:b,onChangeColours:y,onChangeRepository:C}),r&&o.jsx("div",{className:n.loading,children:o.jsx(T,{theme:s})}),!r&&i&&o.jsxs(a,{...e,colours:l.colors,entries:i,theme:s,currentBranch:c,paging:{page:e.page??0,size:e.pageSize??i.length},classes:{containerStyles:{background:m},containerClass:n.gitLogContainer},indexStatus:{added:2,modified:5,deleted:1},urls:p,children:[e.showBranchesTags&&o.jsx(a.Tags,{}),o.jsx(a.Graph,{nodeSize:e.nodeSize,nodeTheme:e.nodeTheme,orientation:e.orientation,enableResize:e.enableResize,showCommitNodeHashes:e.showCommitNodeHashes,showCommitNodeTooltips:e.showCommitNodeTooltips}),e.showTable&&o.jsx(a.Table,{className:n.table,timestampFormat:e.timestampFormat})]})]})}};var h,d,g;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: args => {
    const {
      theme,
      loading,
...
}`,...(g=(d=t.parameters)==null?void 0:d.docs)==null?void 0:g.source}}};const L=["Demo"];export{t as Demo,L as __namedExportsOrder,H as default};
