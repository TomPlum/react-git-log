import{r as y,j as t}from"./iframe-LhFDjmOA.js";import{c,u as z,s as g,S as H,L as j,a as w,G as x}from"./StoryHeader-CPvA5AEk.js";import"./index-Cd895Nzh.js";const R="_pagination_3vy2g_1",D="_pages_3vy2g_6",P="_pageButton_3vy2g_13",L="_active_3vy2g_18",B="_chevronButton_3vy2g_21",A="_disabled_3vy2g_27",i={pagination:R,pages:D,pageButton:P,active:L,chevronButton:B,disabled:A},S=({theme:e,pageSize:r,currentPage:n,total:d,onChangePage:l})=>{const a=Math.ceil(d/r),m=Array.from({length:a},(o,u)=>u+1),p=y.useMemo(()=>{const u=Math.floor(5.5);let h=Math.max(1,n-u),s=h+11-1;return s>a&&(s=a,h=Math.max(1,s-11+1)),m.slice(h-1,s)},[n,m,a]);return t.jsxs("div",{className:i.pagination,children:[t.jsx("button",{disabled:n===1,className:c(i.chevronButton,{[i.disabled]:n===1}),onClick:()=>l(1),style:{color:e==="dark"?"white":"black"},children:"<<"}),t.jsx("button",{disabled:n===1,className:c(i.chevronButton,{[i.disabled]:n===1}),onClick:()=>l(n-1),style:{color:e==="dark"?"white":"black"},children:"<"}),t.jsx("div",{className:i.pages,children:p.map(o=>t.jsx("button",{onClick:()=>l(o),className:c(i.pageButton,{[i.active]:o===n}),style:{color:e==="dark"?"white":"black"},title:`Go to page ${o}`,children:o},o))}),t.jsx("button",{className:c(i.chevronButton,{[i.disabled]:n===a}),disabled:n===a,onClick:()=>l(n+1),style:{color:e==="dark"?"white":"black"},children:">"}),t.jsx("button",{className:c(i.chevronButton,{[i.disabled]:n===a}),disabled:n===a,onClick:()=>l(a),style:{color:e==="dark"?"white":"black"},children:">>"})]})};try{S.displayName="Pagination",S.__docgenInfo={description:"",displayName:"Pagination",props:{theme:{defaultValue:null,description:"",name:"theme",required:!0,type:{name:"ThemeMode"}},currentPage:{defaultValue:null,description:"",name:"currentPage",required:!0,type:{name:"number"}},pageSize:{defaultValue:null,description:"",name:"pageSize",required:!0,type:{name:"number"}},total:{defaultValue:null,description:"",name:"total",required:!0,type:{name:"number"}},onChangePage:{defaultValue:null,description:"",name:"onChangePage",required:!0,type:{name:"(pageNumber: number) => void"}},onChangePageSize:{defaultValue:null,description:"",name:"onChangePageSize",required:!0,type:{name:"(pageSize: number) => void"}}}}}catch{}const v=e=>{const[r,n]=y.useState(1),[d,l]=y.useState(20),{theme:a,loading:m,colours:p,entries:o,branch:u,buildUrls:h,repository:s,headCommitHash:G,backgroundColour:C,handleChangeTheme:k,handleChangeColors:q,handleChangeRepository:_}=z({isServerSidePaginated:!0});return t.jsxs("div",{style:{background:C},className:g.container,children:[t.jsx(H,{theme:a,colours:p,repository:s,onChangeTheme:k,onChangeColours:q,onChangeRepository:_,children:t.jsx("div",{style:{marginTop:20},children:t.jsx(S,{theme:a,pageSize:d,currentPage:r,total:(o==null?void 0:o.length)??0,onChangePage:b=>n(b),onChangePageSize:b=>l(b)})})}),m&&t.jsx("div",{className:g.loading,children:t.jsx(j,{theme:a})}),!m&&o&&t.jsxs(w,{...e,theme:a,entries:o.slice(d*(r-1),d*r),branchName:u,colours:p.colors,headCommitHash:G,classes:{containerStyles:{background:C},containerClass:g.gitLogContainer},indexStatus:{added:e.indexStatusFilesAdded,modified:e.indexStatusFilesModified,deleted:e.indexStatusFilesDeleted},urls:h,children:[e.renderStrategy==="html-grid"&&t.jsx(x.GraphHTMLGrid,{nodeSize:e.nodeSize,nodeTheme:e.nodeTheme,orientation:e.orientation,enableResize:e.enableResize,showCommitNodeHashes:e.showCommitNodeHashes,showCommitNodeTooltips:e.showCommitNodeTooltips}),e.renderStrategy==="canvas"&&t.jsx(x.GraphCanvas2D,{nodeSize:e.nodeSize,nodeTheme:e.nodeTheme,orientation:e.orientation,enableResize:e.enableResize}),e.showTable&&t.jsx(w.Table,{className:g.table,timestampFormat:e.timestampFormat})]})]})};try{v.displayName="GitLogPagedDemo",v.__docgenInfo={description:"",displayName:"GitLogPagedDemo",props:{showTable:{defaultValue:null,description:"",name:"showTable",required:!0,type:{name:"boolean"}},showCommitNodeHashes:{defaultValue:null,description:`Whether to show the commit hash
