    ...
    return <div style={{
      background: backgroundColour
        ...
        containerClass: styles.gitLogContainer
            ...
            <GitLog.Graph nodeSize={args.nodeSize} nodeTheme={args.nodeTheme} enableResize={args.enableResize} showCommitNodeHashes={args.showCommitNodeHashes} showCommitNodeTooltips={args.showCommitNodeTooltips} />

            {args.showTable && <GitLog.Table className={styles.table} timestampFormat={args.timestampFormat} />}
          </GitLog>}
      </div>;
  }
}`,...(c=(g=s.parameters)==null?void 0:g.docs)==null?void 0:c.source}}};const H=["Demo"];export{s as Demo,H as __namedExportsOrder,f as default};
