    ...
    return <div style={{
      background: backgroundColour
        ...
        containerClass: styles.gitLogContainer
            ...
            <GitLogPaged.Graph nodeSize={args.nodeSize} nodeTheme={args.nodeTheme} enableResize={args.enableResize} showCommitNodeHashes={args.showCommitNodeHashes} showCommitNodeTooltips={args.showCommitNodeTooltips} />

            {args.showTable && <GitLogPaged.Table className={styles.table} timestampFormat={args.timestampFormat} />}
          </GitLogPaged>}
      </div>;
  }
}`,...(z=(v=b.parameters)==null?void 0:v.docs)==null?void 0:z.source}}};const U=["Demo"];export{b as Demo,U as __namedExportsOrder,$ as default};
