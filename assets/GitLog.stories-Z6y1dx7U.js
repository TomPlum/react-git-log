import{j as n}from"./iframe-CBYtbNdG.js";import{u as G,s as t,S as k,L as N,G as a}from"./StoryHeader-Q7j2CHV4.js";import"./index-Coalw9ed.js";const b=e=>{const{theme:o,loading:i,colours:s,entries:r,branch:c,buildUrls:p,repository:d,backgroundColour:u,handleChangeTheme:g,handleChangeColors:f,handleChangeRepository:l}=G();return n.jsxs("div",{style:{background:u},className:t.container,children:[n.jsx(k,{theme:o,colours:s,repository:d,onChangeTheme:g,onChangeColours:f,onChangeRepository:l}),i&&n.jsx("div",{className:t.loading,children:n.jsx(N,{theme:o})}),!i&&r&&n.jsxs(a,{...e,colours:s.colors,entries:r,theme:o,currentBranch:c,paging:{page:e.page??0,size:e.pageSize??r.length},classes:{containerStyles:{background:u},containerClass:t.gitLogContainer},indexStatus:{added:e.indexStatusFilesAdded,modified:e.indexStatusFilesModified,deleted:e.indexStatusFilesDeleted},urls:p,children:[e.showBranchesTags&&n.jsx(a.Tags,{}),e.renderStrategy==="html-grid"&&n.jsx(a.GraphHTMLGrid,{nodeSize:e.nodeSize,nodeTheme:e.nodeTheme,orientation:e.orientation,enableResize:e.enableResize,showCommitNodeHashes:e.showCommitNodeHashes,showCommitNodeTooltips:e.showCommitNodeTooltips}),e.renderStrategy==="canvas"&&n.jsx(a.GraphCanvas2D,{nodeSize:e.nodeSize,nodeTheme:e.nodeTheme,orientation:e.orientation,enableResize:e.enableResize}),e.showTable&&n.jsx(a.Table,{className:t.table,timestampFormat:e.timestampFormat})]})]})};try{b.displayName="GitLogDemo",b.__docgenInfo={description:"",displayName:"GitLogDemo",props:{pageSize:{defaultValue:null,description:"",name:"pageSize",required:!1,type:{name:"number | undefined"}},page:{defaultValue:null,description:"",name:"page",required:!1,type:{name:"number | undefined"}},showTable:{defaultValue:null,description:"",name:"showTable",required:!0,type:{name:"boolean"}},showBranchesTags:{defaultValue:null,description:"",name:"showBranchesTags",required:!0,type:{name:"boolean"}},showCommitNodeHashes:{defaultValue:null,description:`Whether to show the commit hash
...
the various elements of the table.`,name:"styles",required:!1,type:{name:"GitLogTableStylingProps | undefined"}}}}}catch{}const L={title:"GitLog",component:a,parameters:{layout:"fullscreen"},args:{entries:[],showTable:!0,currentBranch:"release",showBranchesTags:!0,showCommitNodeHashes:!1,showCommitNodeTooltips:!1,showHeaders:!0,showGitIndex:!0,enableResize:!1,nodeTheme:"default",renderStrategy:"html-grid",nodeSize:20,orientation:"normal",onSelectCommit:e=>{console.info(`Selected commit ${e==null?void 0:e.hash}`)},defaultGraphWidth:120,rowSpacing:0,page:0,pageSize:200,indexStatusFilesModified:5,indexStatusFilesAdded:2,indexStatusFilesDeleted:1},argTypes:{entries:{name:"Git Log Entries",table:{category:"Required Props"}},currentBranch:{name:"Current Branch",table:{category:"Required Props"}},showCommitNodeHashes:{name:"Show Commit Hashes",table:{category:"Visibility"}},showTable:{name:"Show Table",table:{category:"Visibility"}},showBranchesTags:{name:"Show Branches / Tags",table:{category:"Visibility"}},showHeaders:{name:"Show Headers",type:"boolean",table:{category:"Visibility"}},showCommitNodeTooltips:{name:"Show Commit Tooltips",table:{category:"Visibility"}},nodeTheme:{name:"Node Style",table:{category:"Visibility"},control:"radio",options:{Default:"default",Plain:"plain"}},showGitIndex:{name:"Show Git Index",type:"boolean",table:{category:"Visibility"}},renderStrategy:{name:"Graph Render Strategy",table:{category:"Visibility"},control:"radio",options:{"HTML Grid":"html-grid",Canvas2D:"canvas"}},pageSize:{name:"Page Size",table:{category:"Pagination"},control:{type:"range",min:1,max:300}},page:{name:"Page Number",table:{category:"Pagination"},control:{type:"range",min:0,max:50}},enableResize:{name:"Enable Resize",table:{category:"Dimensions"}},rowSpacing:{name:"Row Spacing",table:{category:"Dimensions"},control:{type:"range",min:0,max:50}},defaultGraphWidth:{name:"Graph Width",table:{category:"Dimensions"},control:{type:"range",min:100,max:500}},nodeSize:{name:"Graph Node Size",table:{category:"Dimensions"},control:{type:"range",min:8,max:30,step:2}},orientation:{name:"Graph Orientation",table:{category:"Dimensions"},control:"radio",options:{Normal:"normal",Flipped:"flipped"}},onSelectCommit:{name:"onSelectCommit",table:{category:"Callback Functions"}},indexStatusFilesModified:{name:"Modified Files",type:{name:"number"},table:{category:"Git Index Status"}},indexStatusFilesAdded:{name:"Added Files",type:{name:"number"},table:{category:"Git Index Status"}},indexStatusFilesDeleted:{name:"Deleted Files",type:{name:"number"},table:{category:"Git Index Status"}},paging:{table:{disable:!0}},theme:{table:{disable:!0}},colours:{table:{disable:!0}},urls:{table:{disable:!0}},classes:{table:{disable:!0}},indexStatus:{table:{disable:!0}}}},h={render:e=>n.jsx(b,{...e})},m=()=>{const{theme:e,loading:o,colours:i,entries:s,branch:r,buildUrls:c,repository:p,backgroundColour:d,handleChangeTheme:u,handleChangeColors:g,handleChangeRepository:f}=G();return n.jsxs("div",{style:{background:d},className:t.container,children:[n.jsx(k,{theme:e,colours:i,repository:p,onChangeTheme:u,onChangeColours:g,onChangeRepository:f}),o&&n.jsx("div",{className:t.loading,children:n.jsx(N,{theme:e})}),!o&&s&&n.jsxs(a,{colours:i.colors,entries:s,theme:e,currentBranch:r,showGitIndex:!1,rowSpacing:80,classes:{containerStyles:{background:d},containerClass:t.gitLogContainer},indexStatus:{added:2,modified:5,deleted:1},urls:c,children:[n.jsx(a.GraphHTMLGrid,{highlightedBackgroundHeight:120}),n.jsx(a.Table,{className:t.table,row:({commit:l,backgroundColour:V})=>{var y;return n.jsxs("div",{className:t.customRow,style:{color:e==="dark"?"white":"black",backgroundColor:V},children:[n.jsx("div",{className:t.top,children:n.jsx("p",{className:t.message,children:l.message})}),n.jsxs("div",{className:t.bottom,children:[n.jsx("p",{className:t.author,style:{color:e==="dark"?"rgb(203,203,203)":"rgb(56,56,56)"},children:(y=l.author)==null?void 0:y.name}),n.jsxs("p",{className:t.hash,style:{color:e==="dark"?"white":"rgb(56,56,56)",background:e==="dark"?"grey":"rgb(224,224,224)"},children:["#",l.hash]})]})]})}})]})]})};var S,w,C;h.parameters={...h.parameters,docs:{...(S=h.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: args => <GitLogDemo {...args} />
}`,...(C=(w=h.parameters)==null?void 0:w.docs)==null?void 0:C.source}}};var x,T,v;m.parameters={...m.parameters,docs:{...(x=m.parameters)==null?void 0:x.docs,source:{originalSource:`() => {
  const {
    theme,
    loading,
    colours,
...
}`,...(v=(T=m.parameters)==null?void 0:T.docs)==null?void 0:v.source}}};const j=["Demo","CustomTableRow"];export{m as CustomTableRow,h as Demo,j as __namedExportsOrder,L as default};
