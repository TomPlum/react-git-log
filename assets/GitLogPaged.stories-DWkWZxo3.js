import{r as y,j as t}from"./iframe-jeak3jFK.js";import{c as p,u as _,a as z,s as g,S as P,L as H,b as w,G as k}from"./StoryHeader-C5I0ex7K.js";import"./index-BYrxniec.js";const D="_pagination_3vy2g_1",R="_pages_3vy2g_6",j="_pageButton_3vy2g_13",B="_active_3vy2g_18",L="_chevronButton_3vy2g_21",A="_disabled_3vy2g_27",o={pagination:D,pages:R,pageButton:j,active:B,chevronButton:L,disabled:A},v=({theme:e,pageSize:d,currentPage:n,total:m,onChangePage:l})=>{const a=Math.ceil(m/d),u=Array.from({length:a},(i,h)=>h+1),s=y.useMemo(()=>{const h=Math.floor(5.5);let c=Math.max(1,n-h),r=c+11-1;return r>a&&(r=a,c=Math.max(1,r-11+1)),u.slice(c-1,r)},[n,u,a]);return t.jsxs("div",{className:o.pagination,children:[t.jsx("button",{disabled:n===1,className:p(o.chevronButton,{[o.disabled]:n===1}),onClick:()=>l(1),style:{color:e==="dark"?"white":"black"},children:"<<"}),t.jsx("button",{disabled:n===1,className:p(o.chevronButton,{[o.disabled]:n===1}),onClick:()=>l(n-1),style:{color:e==="dark"?"white":"black"},children:"<"}),t.jsx("div",{className:o.pages,children:s.map(i=>t.jsx("button",{onClick:()=>l(i),className:p(o.pageButton,{[o.active]:i===n}),style:{color:e==="dark"?"white":"black"},title:`Go to page ${i}`,children:i},i))}),t.jsx("button",{className:p(o.chevronButton,{[o.disabled]:n===a}),disabled:n===a,onClick:()=>l(n+1),style:{color:e==="dark"?"white":"black"},children:">"}),t.jsx("button",{className:p(o.chevronButton,{[o.disabled]:n===a}),disabled:n===a,onClick:()=>l(a),style:{color:e==="dark"?"white":"black"},children:">>"})]})};try{v.displayName="Pagination",v.__docgenInfo={description:"",displayName:"Pagination",props:{theme:{defaultValue:null,description:"",name:"theme",required:!0,type:{name:"enum",value:[{value:'"light"'},{value:'"dark"'}]}},currentPage:{defaultValue:null,description:"",name:"currentPage",required:!0,type:{name:"number"}},pageSize:{defaultValue:null,description:"",name:"pageSize",required:!0,type:{name:"number"}},total:{defaultValue:null,description:"",name:"total",required:!0,type:{name:"number"}},onChangePage:{defaultValue:null,description:"",name:"onChangePage",required:!0,type:{name:"(pageNumber: number) => void"}},onChangePageSize:{defaultValue:null,description:"",name:"onChangePageSize",required:!0,type:{name:"(pageSize: number) => void"}}}}}catch{}const S=e=>{const[d,n]=y.useState(1),[m,l]=y.useState(20),{loading:a,colours:u,entries:s,branch:i,buildUrls:h,repository:c,headCommitHash:r,backgroundColour:C,handleChangeColors:q,handleChangeRepository:G}=_({isServerSidePaginated:!0}),{theme:T}=z();return t.jsxs("div",{style:{background:C},className:g.container,children:[t.jsx(P,{colours:u,repository:c,onChangeColours:q,onChangeRepository:G,children:t.jsx("div",{style:{marginTop:20},children:t.jsx(v,{theme:T,pageSize:m,currentPage:d,total:(s==null?void 0:s.length)??0,onChangePage:f=>n(f),onChangePageSize:f=>l(f)})})}),a&&t.jsx("div",{className:g.loading,children:t.jsx(H,{})}),!a&&s&&t.jsxs(w,{...e,theme:T,entries:s.slice(m*(d-1),m*d),branchName:i,colours:u.colors,headCommitHash:r,classes:{containerStyles:{background:C},containerClass:g.gitLogContainer},urls:h,children:[e.renderStrategy==="html-grid"&&t.jsx(k.GraphHTMLGrid,{nodeSize:e.nodeSize,nodeTheme:e.nodeTheme,orientation:e.orientation,enableResize:e.enableResize,showCommitNodeHashes:e.showCommitNodeHashes,showCommitNodeTooltips:e.showCommitNodeTooltips}),e.renderStrategy==="canvas"&&t.jsx(k.GraphCanvas2D,{nodeSize:e.nodeSize,nodeTheme:e.nodeTheme,orientation:e.orientation,enableResize:e.enableResize}),e.showTable&&t.jsx(w.Table,{className:g.table,timestampFormat:e.timestampFormat})]})]})};try{S.displayName="GitLogPagedDemo",S.__docgenInfo={description:"",displayName:"GitLogPagedDemo",props:{showTable:{defaultValue:null,description:"",name:"showTable",required:!0,type:{name:"boolean"}},showCommitNodeHashes:{defaultValue:null,description:`Whether to show the commit hash
