...
the various elements of the table.`,name:"styles",required:!1,type:{name:"GitLogTableStylingProps | undefined"}}}}}catch{}const q={title:"GitLog",component:a,parameters:{layout:"fullscreen"},args:{entries:[],showTable:!0,currentBranch:"release",showBranchesTags:!0,showCommitNodeHashes:!1,showCommitNodeTooltips:!1,enablePreviewedCommitStyling:!0,enableSelectedCommitStyling:!0,showHeaders:!0,showGitIndex:!0,enableResize:!1,nodeTheme:"default",breakPointTheme:"dot",renderStrategy:"html-grid",nodeSize:20,orientation:"normal",onSelectCommit:e=>{console.info(`Selected commit ${e?.hash}`)},defaultGraphWidth:120,rowSpacing:0,page:0,pageSize:200,indexStatusFilesModified:5,indexStatusFilesAdded:2,indexStatusFilesDeleted:1},argTypes:{entries:{name:"Git Log Entries",table:{category:"Required Props"}},currentBranch:{name:"Current Branch",table:{category:"Required Props"}},showCommitNodeHashes:{name:"Show Commit Hashes",table:{category:"Visibility"}},showTable:{name:"Show Table",table:{category:"Visibility"}},showBranchesTags:{name:"Show Branches / Tags",table:{category:"Visibility"}},showHeaders:{name:"Show Headers",type:"boolean",table:{category:"Visibility"}},showCommitNodeTooltips:{name:"Show Commit Tooltips",table:{category:"Visibility"}},nodeTheme:{name:"Node Style",table:{category:"Visibility"},control:{type:"select",labels:{default:"Default",plain:"Plain"}},options:["default","plain"]},breakPointTheme:{name:"Break Point Style",table:{category:"Visibility"},control:{type:"select",labels:{slash:"Slash",dot:"Dot",ring:"Ring","zig-zag":"Zig-Zag",line:"Line","double-line":"Double Line",arrow:"Arrow"}},options:["slash","dot","ring","zig-zag","line","double-line","arrow"]},showGitIndex:{name:"Show Git Index",type:"boolean",table:{category:"Visibility"}},renderStrategy:{name:"Graph Render Strategy",table:{category:"Visibility"},control:{type:"select",labels:{"html-grid":"HTML Grid",canvas:"Canvas2D"}},options:["html-grid","canvas"]},enableSelectedCommitStyling:{name:"Enable Selection Styling",type:"boolean",table:{category:"Visibility"}},enablePreviewedCommitStyling:{name:"Enable Preview Styling",type:"boolean",table:{category:"Visibility"}},pageSize:{name:"Page Size",table:{category:"Pagination"},control:{type:"range",min:1,max:300}},page:{name:"Page Number",table:{category:"Pagination"},control:{type:"range",min:0,max:50}},enableResize:{name:"Enable Resize",table:{category:"Dimensions"}},rowSpacing:{name:"Row Spacing",table:{category:"Dimensions"},control:{type:"range",min:0,max:50}},defaultGraphWidth:{name:"Graph Width",table:{category:"Dimensions"},control:{type:"range",min:100,max:500}},nodeSize:{name:"Graph Node Size",table:{category:"Dimensions"},control:{type:"range",min:8,max:30,step:2}},orientation:{name:"Graph Orientation",table:{category:"Dimensions"},control:{type:"select",labels:{normal:"Normal",flipped:"Flipped"}},options:["normal","flipped"]},onSelectCommit:{name:"onSelectCommit",table:{category:"Callback Functions"}},onPreviewCommit:{name:"onPreviewCommit",table:{category:"Callback Functions"}},indexStatusFilesModified:{name:"Modified Files",type:{name:"number"},table:{category:"Git Index Status"}},indexStatusFilesAdded:{name:"Added Files",type:{name:"number"},table:{category:"Git Index Status"}},indexStatusFilesDeleted:{name:"Deleted Files",type:{name:"number"},table:{category:"Git Index Status"}},paging:{table:{disable:!0}},theme:{table:{disable:!0}},colours:{table:{disable:!0}},urls:{table:{disable:!0}},classes:{table:{disable:!0}},indexStatus:{table:{disable:!0}},filter:{table:{disable:!0}}}},p={render:e=>n.jsx(C,{...e})},b=()=>{const{loading:e,colours:s,entries:r,branch:l,buildUrls:m,repository:c,backgroundColour:d,handleChangeColors:u,handleChangeRepository:h}=S(),{theme:o}=v();return n.jsxs("div",{style:{background:d},className:t.container,children:[n.jsx(x,{colours:s,repository:c,onChangeColours:u,onChangeRepository:h}),e&&n.jsx("div",{className:t.loading,children:n.jsx(k,{})}),!e&&r&&n.jsxs(a,{colours:s.colors,entries:r,theme:o,currentBranch:l,showGitIndex:!1,rowSpacing:80,classes:{containerStyles:{background:d},containerClass:t.gitLogContainer},indexStatus:{added:2,modified:5,deleted:1},urls:m,children:[n.jsx(a.GraphHTMLGrid,{highlightedBackgroundHeight:120}),n.jsx(a.Table,{className:t.table,row:({commit:i,backgroundColour:g})=>n.jsxs("div",{className:t.customRow,style:{color:o==="dark"?"white":"black",backgroundColor:g},children:[n.jsx("div",{className:t.top,children:n.jsx("p",{className:t.message,children:i.message})}),n.jsxs("div",{className:t.bottom,children:[n.jsx("p",{className:t.author,style:{color:o==="dark"?"rgb(203,203,203)":"rgb(56,56,56)"},children:i.author?.name}),n.jsxs("p",{className:t.hash,style:{color:o==="dark"?"white":"rgb(56,56,56)",background:o==="dark"?"grey":"rgb(224,224,224)"},children:["#",i.hash]})]})]})})]})]})},T=["millie","neo","millie_neo","neo_banana","neo_2","bella"],y=()=>{const{loading:e,colours:s,entries:r,branch:l,buildUrls:m,repository:c,backgroundColour:d,handleChangeColors:u,handleChangeRepository:h}=S(),{theme:o}=v();return n.jsxs("div",{style:{background:d},className:t.container,children:[n.jsx(x,{colours:s,repository:c,onChangeColours:u,onChangeRepository:h}),e&&n.jsx("div",{className:t.loading,children:n.jsx(k,{})}),!e&&r&&n.jsxs(a,{colours:s.colors,entries:r,theme:o,currentBranch:l,classes:{containerStyles:{background:d},containerClass:t.gitLogContainer},indexStatus:{added:2,modified:5,deleted:1},urls:m,children:[n.jsx(a.GraphHTMLGrid,{nodeSize:25,node:({nodeSize:i,colour:g,isIndexPseudoNode:f,rowIndex:w})=>n.jsx("div",{className:t.Node,style:{width:i,height:i,background:`url('https://placecats.com/${T[w%T.length]}/50/50?fit=contain&position=top') 50% 50%`,border:`2px ${f?"dotted":"solid"} ${g}`}})}),n.jsx(a.Table,{className:t.table})]})]})};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
...
}`,...y.parameters?.docs?.source}}};const z=["Demo","CustomTableRow","CustomCommitNode"];export{y as CustomCommitNode,b as CustomTableRow,p as Demo,z as __namedExportsOrder,q as default};
